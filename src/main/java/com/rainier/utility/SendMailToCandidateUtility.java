...
public class SendMailToCandidateUtility {
	private static final Logger logger = Logger.getLogger(SendMailToCandidateUtility.class);

	  public String fromMail = "",mailPwd="", toMail = "", host = "smtp.gmail.com",  subject = "";
	  
	  
	  public SendMailToCandidateUtility() {
	  ...
	  synchronized public boolean sendToCandidate(String toMail,String name) {
		  logger.info("entered into send method of utility class");
		  boolean sent= false;
		 // String emailBody="Dear toName Your Application has been Submitted Successfully...";
		  ...
		  String emailBody = "<!DOCTYPE html>\r\n" + "<html lang=\"en\">\r\n" + "   <head>\r\n"
	                ...
	                + "                                                <span style=\"font-family: Arial, Helvetica, sans-serif;font-size: 15px;color: #8c8e8d;text-align: left;line-height: 24px;\">Your Application  Has Been Submitted Successfully. </span></font>\r\n"
	                + "                                             </div>\r\n"
	                + "                                             <!-- padding -->\r\n"
	                + "                                          </td>\r\n"
	                + "                                       </tr>\r\n"
	                ...
	                + "    line-height: 18px;\r\n" + "\">\r\n"
	                + "                                                <span style=\"font-family: Arial, Helvetica, sans-serif;font-size: 16px;/* color: #8c8e8d; */text-align: left;\">Regards <br>Recruitment Team</span></font>\r\n"
	                + "                                             </div>\r\n"
	                + "                                             <!-- padding -->\r\n"
	                + "                                          </td>\r\n"
	                + "                                       </tr>\r\n"
